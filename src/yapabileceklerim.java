...
public class yapabileceklerim extends JFrame {
	...
	private void initialize() {
		...
		JLabel label_3 = new JLabel("M�Z�K");
		label_3.setHorizontalAlignment(SwingConstants.CENTER);
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 15));
		label_3.setBounds(267, 130, 120, 14);
		contentPane.add(label_3);
		
		JLabel label_4 = new JLabel("B�LG�SAYAR");
		...
		JLabel label_6 = new JLabel("B�T�R");
		label_6.setHorizontalAlignment(SwingConstants.CENTER);
		label_6.setFont(new Font("Tahoma", Font.PLAIN, 15));
		label_6.setBounds(267, 230, 120, 14);
		contentPane.add(label_6);
		
		JLabel label_7 = new JLabel("TAKV�M");
		...
		btnBasla.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String inp = "C:\\Users\\Mustafa\\Desktop\\sesler\\music\\music.mp3";
					MWCharArray pc = new MWCharArray(pcs);// pc adi al�ncak
					MWCharArray folder = new MWCharArray(folders);// training_words m� testing_words� m�
					MWCharArray filename = new MWCharArray(filenames);// dosya ad�
					...
					MWCharArray yap�lacaklarfolder = new MWCharArray("yapilacaklar");//
					...
					TODOLIST list = new TODOLIST(result, slient, train, train_all, test, kayit, noise, pc, folder, filename, pcs,yap�lacaklarfolder);
